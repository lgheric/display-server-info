jQuery(document).ready(function ($) {
    ...
    $('#disi_enable_admin_bar, #disi_enable_widget, #disi_enable_footer, #disi_enable_shortcode').on('change', function () {

        if (typeof disiAjaxObject !== 'undefined') {

             $('#spinnerModal').removeClass('disi-hidden');
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#spinnerModal').addClass('disi-hidden');
                    if (response.success) {
                        showToast(disiAjaxObject.disiLocalizeText.settingsSavedText,'default');
                    } else {
                        showToast(disiAjaxObject.disiLocalizeText.errorOccurredText + '：' + response.data.message,'error');
                    }
                },
                error: function (xhr) {
